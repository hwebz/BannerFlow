...
var MusicEqualizerBar = (function(){
    ...
    function startWidget(currentSesssion){
      ...
      ctx.fillStyle = color;
      duration = (baseDuration/speed * 1000)/durationTimeoutAnimate;
      allBars = new Array();
    ...
    function loadSettings() {
        ...
        if(typeof BannerFlow !== "undefined") {
          ...
          space = BannerFlow.settings.space;
...
if(typeof BannerFlow == "undefined"){
    ...
    BannerFlow.addEventListener(BannerFlow.RESIZE, function () {
        MusicEqualizerBar.onResized();
    });

    BannerFlow.addEventListener(BannerFlow.SETTINGS_CHANGED, function () {
        MusicEqualizerBar.onSettingChanged();
    });
